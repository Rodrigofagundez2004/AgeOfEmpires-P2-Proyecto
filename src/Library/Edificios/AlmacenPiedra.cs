...
namespace Library
{
    public class AlmacenPiedra : Edificio, IAlmacenes
    {
        ...
        public AlmacenPiedra(int x = 0, int y = 0)
            : base(1000, 1000, "Almacén de Piedra", x, y, Iconos.AlmacenPiedra, costo: new CostoConstruccion(madera: 20, piedra: 15, oro: 10, alimento: 0))
        {
        }
        public bool AceptaRecurso(TipoRecurso tipo)
        {
            return tipo == TipoRecurso.Piedra;
        }
